...
const { getAllUsers, getAllContacts, deleteUserById, getUserById, updateUserById, deleteContactById } = require("../controllers/getAllUsers-controller");
...
router.route('/contacts/delete/:id').delete(authMiddlewere, adminMiddleware, deleteContactById);
